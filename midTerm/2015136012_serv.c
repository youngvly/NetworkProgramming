/**python compile 
gcc 2015136012_serv.c -o 2015136012_serv -I/usr/include/python2.7 -pthread -lm -lutil /usr/lib/python2.7/config-x86_64-linux-gnu/libpython2.7.so
...
int main(int argc, char *argv[]) {
	...
	PyRun_SimpleString("import writexml2015136012");
	PyRun_SimpleString("writexml2015136012.makeRecordFile()");
	PySys_SetArgv(argc,argv);
	PyObject *name,*ptime,*msg,*pdic,*pmodule,*pfunc,*pargs,*funcname,*modulename;
	/***************************/	
	...
	//broadcast recieved message to all Client 
		...
		//save message 
			...
			modulename = PyString_FromString("writexml2015136012");
	...
	if(FD_ISSET(0,&read_fds)){				//내 키보드 변경 감지
		if (fgets(bufmsg,MAXLINE,stdin)){
			...
			//---------SHOW CHATTING MENU
				...
				PyRun_SimpleString("import readxml2015136012");
				PyRun_SimpleString("readxml2015136012.readxml()");
